<div class="container">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="my-5">
                <form method="post" class="text-center border border-light p-5" action="<?php URL ?>newUser/createUser">
                    ...
                    <button class="btn btn-info my-4 btn-block" type="submit" id="submit">Crea l'utente</button>
